...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<div class='header widthmain clearfix'>
        ...
        ?>
        <?php $pageTitle = $_GET['title'] ?>
    <div id="<?php echo $menu; ?>">
	<div class="infobanner">
				<jdoc:include type="modules" name="baner-all-sub-page" style="xhtml" />      
    </div>
        <div class='bg-tilte'>
             <h3 class='widthgrid'><?php echo $pageTitle; ?></h3>
        </div>
	
	<div class='bg-gray'>
        <div class="widthgrid clearfix">
			<jdoc:include type="modules" name="sub-school-trip" style="xhtml" />
        </div>
