...
*/
  ...
  $.fn.extend({
    ...
    buildTooltip: function(cont,options){
      ...
      $.extend (this.options, options);
      var parent=$(this);
      $("body").append("<div id='mbtooltip'></div>");
      var imgUrl=this.options.imgPath+"up.png";
      $("#mbtooltip").html(cont);
      $("#mbtooltip").addClass(this.options.cssClass);
      if (this.options.hasArrow){
        $("#mbtooltip").prepend("<img id='ttimg' src='"+imgUrl+"'>");
        $("#ttimg").css({
          position:"absolute",
          opacity:.5
        });
      ...
      $("#mbtooltip").findBestPos(parent,this.options.imgPath,this.options.anchor);
      if (this.options.anchor=="mouse") $(document).unbind("mousemove");
      if (this.options.hasShadow) {
        $("#mbtooltip").dropShadow({left: this.options.shadowLeft, top: this.options.shadowTop, blur: 2, opacity: 0.3, color:this.options.shadowColor});
        $(".dropShadow").css("display","none");
        $(".dropShadow").mb_bringToFront();
        $(".dropShadow").fadeIn(this.options.mb_fade);
      }
      $("#mbtooltip").mb_bringToFront();
      $("#mbtooltip").fadeTo(this.options.mb_fade,this.options.opacity,function(){});
    ...
    deleteTooltip: function(hasShadow,fade){
      var sel=hasShadow?"#mbtooltip,.dropShadow":"#mbtooltip";
    ...
    disableTooltip:function(){
      $(this).find("[mbtooltip]").attr("tooltipEnable","false");
    },
    enableTooltip:function(){
      $(this).find("[mbtooltip]").attr("tooltipEnable","true");
    }
  });
